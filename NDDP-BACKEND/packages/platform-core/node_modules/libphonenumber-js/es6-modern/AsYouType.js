...
export default class AsYouType {
  ...
  determineTheCountry() {
    ...
    const country = getCountryByCallingCode(this.isInternational() ? this.state.callingCode : this.defaultCallingCode, {
  ...
  getNumber() {
    ...
    if (country) {
      if (country === this.defaultCountry) {
        ...
        const exactCountry = getExactCountryForMultiCountryCallingCode(countryCallingCode, nationalSignificantNumber, this.metadata);
        if (exactCountry) {
