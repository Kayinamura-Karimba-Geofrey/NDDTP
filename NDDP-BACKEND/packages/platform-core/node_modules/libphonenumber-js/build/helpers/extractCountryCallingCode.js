...
function extractCountryCallingCode(number, country, defaultCountry, defaultCallingCode, metadataJson) {
  ...
  if (number[0] !== '+') {
    ...
    var numberWithoutIDD = (0, _stripIddPrefix["default"])(number, country || defaultCountry, defaultCallingCode, metadataJson);
    ...
    if (numberWithoutIDD && numberWithoutIDD !== number) {
      ...
      if (country || defaultCountry || defaultCallingCode) {
        var _extractCountryCallin = (0, _extractCountryCallingCodeFromInternationalNumberWithoutPlusSign["default"])(number, country, defaultCountry, defaultCallingCode, metadataJson),
