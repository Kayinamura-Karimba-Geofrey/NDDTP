 ...
 * @return {string}
 */
function _default(number, from_country, with_formatting, metadataJson) {
  ...
  if (country === from_country) {
    ...
    if (country == 'BR' && is_fixed_line_or_mobile) {
      ...
      if (can_be_internationally_dialled(number) && (0, _checkNumberLength["default"])(number.phone, undefined, metadata) !== 'TOO_SHORT') {
