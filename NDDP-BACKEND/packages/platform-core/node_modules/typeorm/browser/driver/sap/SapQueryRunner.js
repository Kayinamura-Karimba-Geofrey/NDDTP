...
export class SapQueryRunner extends BaseQueryRunner {
    ...
    async release() {
        ...
        if (this.databaseConnection) {
            ...
            try {
                await promisify(this.databaseConnection.disconnect).call(this.databaseConnection);
            }
            catch (error) {
    ...
    async query(query, parameters, useStructuredResult = false) {
        ...
        try {
            ...
            if (isInsertQuery) {
                ...
                try {
                    const identityValueResult = await promisify(databaseConnection.exec).call(databaseConnection, lastIdQuery);
                    result.raw =
    ...
    async loadTables(tableNames) {
        ...
        return dbTables.map((dbTable) => {
            ...
            const tableCheckConstraints = OrmUtils.uniq(dbConstraints.filter((dbConstraint) => dbConstraint["TABLE_NAME"] === dbTable["TABLE_NAME"] &&
                dbConstraint["SCHEMA_NAME"] ===
                    dbTable["SCHEMA_NAME"] &&
            ...
            const tableForeignKeyConstraints = OrmUtils.uniq(dbForeignKeys.filter((dbForeignKey) => dbForeignKey["TABLE_NAME"] === dbTable["TABLE_NAME"] &&
