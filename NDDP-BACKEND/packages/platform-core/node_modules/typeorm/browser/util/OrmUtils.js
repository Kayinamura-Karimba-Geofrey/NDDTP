    ...
    static normalizeWhereCriteria(criteria, options, path) {
        ...
        for (const [key, value] of Object.entries(criteria)) {
            ...
            if (value === undefined) {
                ...
                if (behavior === "throw") {
                    throw new TypeORMError(`Undefined value encountered in property '${propertyPath}' of a where condition. ` +
                ...
                if (behavior === "throw") {
                    throw new TypeORMError(`Null value encountered in property '${propertyPath}' of a where condition. ` +
