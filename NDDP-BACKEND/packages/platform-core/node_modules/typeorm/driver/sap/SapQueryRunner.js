...
class SapQueryRunner extends BaseQueryRunner_1.BaseQueryRunner {
    ...
    async query(query, parameters, useStructuredResult = false) {
        ...
        try {
            ...
            try {
                raw = statement
                    ? await (0, node_util_1.promisify)(statement.exec).call(statement, parameters)
                    : await (0, node_util_1.promisify)(databaseConnection.exec).call(databaseConnection, query, parameters, {});
            }
            catch (err) {
    ...
    async loadTables(tableNames) {
        ...
        return dbTables.map((dbTable) => {
            ...
            const tableCheckConstraints = OrmUtils_1.OrmUtils.uniq(dbConstraints.filter((dbConstraint) => dbConstraint["TABLE_NAME"] === dbTable["TABLE_NAME"] &&
                dbConstraint["SCHEMA_NAME"] ===
                    dbTable["SCHEMA_NAME"] &&
            ...
            const tableForeignKeyConstraints = OrmUtils_1.OrmUtils.uniq(dbForeignKeys.filter((dbForeignKey) => dbForeignKey["TABLE_NAME"] === dbTable["TABLE_NAME"] &&
                dbForeignKey["SCHEMA_NAME"] === dbTable["SCHEMA_NAME"]), (dbForeignKey) => dbForeignKey["CONSTRAINT_NAME"]);
