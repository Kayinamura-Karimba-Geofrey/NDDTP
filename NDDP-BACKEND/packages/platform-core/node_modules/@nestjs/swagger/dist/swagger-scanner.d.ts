...
export declare class SwaggerScanner {
    ...
    scanModuleControllers(controller: Map<InjectionToken, InstanceWrapper>, modulePath: string | undefined, globalPrefix: string | undefined, applicationConfig: ApplicationConfig, operationIdFactory?: OperationIdFactory, linkNameFactory?: (controllerKey: string, methodKey: string, fieldKey: string) => string, autoTagControllers?: boolean): ModuleRoute[];
