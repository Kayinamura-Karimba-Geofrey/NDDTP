...
import { DuplicateResourceException, ResourceNotFoundException } from '../../common/exceptions/fleet.exceptions';
...
export class VehicleTypeService {
  ...
  async create(dto: CreateVehicleTypeDto) {
    ...
    this.logger.log(`Vehicle type created: ${type.code}`);
    return type;
  }
  ...
  async findById(id: string) {
    ...
    if (!type) throw new ResourceNotFoundException('VehicleType', id);
    return type;
  }
}
