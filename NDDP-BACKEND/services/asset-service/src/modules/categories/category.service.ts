...
import { DuplicateResourceException, ResourceNotFoundException } from '../../common/exceptions/asset.exceptions';
...
export class CategoryService {
  ...
  async findById(id: string) {
    ...
    if (!category) throw new ResourceNotFoundException('AssetCategory', id);
    return category;
  }
}
