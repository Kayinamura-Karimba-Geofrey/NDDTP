...
export function MedicalIncidentsPage() {
  ...
  return (
    <div>
      <PageHeader breadcrumbs={[{ label: 'Medical', path: '/medical/dashboard' }, { label: 'Incidents' }]} title="Medical Incidents" description="Workplace medical incidents and follow-up" actions={<Button onClick={() => toast('Report incident')}><FiPlus className="h-4 w-4" /> Report Incident</Button>} />
      <MedicalSubNav />
      <Card>
