...
import { useGetAiConversationsQuery } from '../api/ai-assistant.api';
import type { AiConversationRecord } from '../constants/ai-assistant-data';

export function AiAssistantConversationsPage() {
  ...
  return (
    <div>
      <PageHeader breadcrumbs={[{ label: 'AI Assistant', path: '/ai-assistant/dashboard' }, { label: 'Conversations' }]} title="Conversations" description="Active, closed, and archived assistant chats" actions={<Link to="/ai-assistant/conversations/new"><Button><FiPlus className="h-4 w-4" /> New Chat</Button></Link>} />
      <AiAssistantSubNav />
