...
import { MOCK_ESCALATIONS } from '../constants/workflow-data';

export function EscalationManagementPage() {
  return (
    <div>
      <PageHeader breadcrumbs={[{ label: 'Workflow', path: '/workflow/dashboard' }, { label: 'Escalation' }]} title="Escalation Management" description="Automatic escalation for overdue tasks — reminder, reassignment, priority increase" />
      <WorkflowSubNav />
      <Card className="mb-6">
