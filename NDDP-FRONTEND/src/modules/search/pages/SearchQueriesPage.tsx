...
export function SearchQueriesPage() {
  ...
  const columns: DataTableColumn<SearchQueryRecord>[] = [
    ...
    { key: 'submittedBy', header: 'By', render: (r) => r.submittedBy },
  ...
  return (
    <div>
      <PageHeader breadcrumbs={[{ label: 'Search', path: '/search/dashboard' }, { label: 'Queries' }]} title="All Queries" description="Platform-wide search query history" actions={<Link to="/search/query"><Button>New Query</Button></Link>} />
