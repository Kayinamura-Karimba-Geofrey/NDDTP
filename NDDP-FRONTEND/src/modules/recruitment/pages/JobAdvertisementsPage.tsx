...
export function JobAdvertisementsPage() {
  ...
  const { data: vacanciesData, isLoading } = useGetVacanciesQuery({ limit: 1 });
  const vacancy = vacanciesData?.data?.[0];
  ...
  return (
    <div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        {isLoading || !vacancy ? (
          <div className="col-span-2 text-center text-muted-foreground p-8">Loading advertisement...</div>
        ) : (
          <>
            <Card>
