...
export const MODULE_CONFIGS: Record<string, ModuleConfig> = {
  ...
  reporting: {
    ...
    description: 'Executive dashboards, KPIs, report library, analytics, forecasting, and BI integrations.',
    permission: 'reporting:read:definitions',
    displayFields: ['name', 'category', 'format', 'status', 'lastRun'],
  },
  analytics: {
    serviceKey: 'analytics',
    listPath: '/reports/analytics',
    title: 'Analytics',
    description: 'Metrics, dashboards, and advanced analytics.',
  ...
  'business-intelligence': {
    ...
    description: 'BI datasets, models, and enterprise platform connectors.',
