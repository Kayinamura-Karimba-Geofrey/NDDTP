...
export const MODULE_CONFIGS: Record<string, ModuleConfig> = {
  ...
  asset: {
    ...
    listPath: '/assets',
    title: 'Assets',
    description: 'Asset categories, assignments, movements, and audits.',
    permission: 'asset:read:assets',
    displayFields: ['assetTag', 'name', 'category', 'status', 'location'],
  },
  inventory: {
    ...
    displayFields: ['sku', 'name', 'category', 'quantityOnHand', 'reorderLevel'],
  },
  logistics: {
