...
import { DuplicateResourceException, ResourceNotFoundException } from '../../common/exceptions/maintenance.exceptions';
...
export class CategoryService {
  ...
  async findById(id: string) {
    ...
    if (!category) throw new ResourceNotFoundException('MaintenanceCategory', id);
    return category;
  }
}
