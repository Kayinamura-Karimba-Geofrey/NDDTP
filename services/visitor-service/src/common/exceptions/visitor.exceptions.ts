...
export class InvalidStatusTransitionException extends HttpException {
  constructor(from: string, to: string) {
    super({ statusCode: HttpStatus.BAD_REQUEST, message: `Cannot transition visit from ${from} to ${to}`, error: 'Bad Request' }, HttpStatus.BAD_REQUEST);
  }
}
...
export class VisitorBlacklistedException extends HttpException {
  constructor(message: string) {
